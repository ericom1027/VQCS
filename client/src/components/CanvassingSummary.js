...
const CanvassingSummary = () => {
  ...
  const handleExportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Canvassing Summary");
    XLSX.writeFile(wb, "Canvassing-Summary.xlsx");
  };
  ...
  return (
    <Box sx={{ display: "flex", height: "100vh", width: "100%" }}>
      ...
      >
        ...
        >
          <h4 className="text-center">Canvassing Summary</h4>
          <div>
            <Box>
            ...
            <TableContainer
              ...
              component={Paper}
            >
              <h6 className="no-display">Canvassing Summary Result</h6>
...
export default CanvassingSummary;
